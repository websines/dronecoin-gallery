...
export default function CreatePostPage() {
  ...
  return (
    <div className="flex min-h-full overflow-y-auto bg-gradient-to-b from-black via-gray-900 to-purple-950">
      <div className="mt-10 flex-1 w-full h-full overflow-y-auto">
